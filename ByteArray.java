...
/*
* http://www.java2s.com/Code/Java/File-Input-Output/Managesfixedlengthbytearrays.htm
...
public final class ByteArray {
   ...
   public float readFloat() {
      float result = readFloat(data, pos);
      pos += 4;
      return result;
   }
   ...
   public static void writeFloat(byte[] data, int offset, float value) {
      ...
      data[offset] = (byte) (intBits >> 24);
      data[offset + 1] = (byte) (intBits >> 16);
      data[offset + 2] = (byte) (intBits >> 8);
      data[offset + 3] = (byte) (intBits);
   }

   // Added by Elroy github@gitteroy
   public ByteArray writeFloat(float value) {
      writeFloat(data, pos, value);
      pos += 4;
      return this;
   }
